...
from proxmox_srvbackup.adapters.email.sender import EmailConfig
from proxmox_srvbackup.adapters.memory import (
    EmailSpy,
...
def test_build_testing_returns_fully_populated_app_services() -> None:
    ...
    from proxmox_srvbackup.composition import AppServices, build_testing
